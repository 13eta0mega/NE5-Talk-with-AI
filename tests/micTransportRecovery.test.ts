...
import { MicTurnDetector } from "../src/core/audio/MicTurnDetector";
...
describe("microphone transport recovery", () => {
  it("detects a local speech end after sustained silence", () => {
  ...
  it("flushes Gemini input audio when local speech ends and before model playback", async () => {
